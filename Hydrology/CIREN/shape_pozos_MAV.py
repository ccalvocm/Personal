...
geodataframe = geopandas.GeoDataFrame(pozos, crs="EPSG:32719",
        geometry = geopandas.points_from_xy(pozos["UTM ESTE"],
            pozos["UTM NORTE"]))

print(geodataframe.head())

geodataframe.to_file("pozos_MAV.shp", driver = "ESRI Shapefile")
