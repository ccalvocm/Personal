...
# parser.add_argument("basins", help="Basins polygon shapefile")
# parser.add_argument("-id", "--id_field", help="Id field (It MUST be integer)")
# parser.add_argument("-n", "--name_field", help="Field with names")
...
# attr_field = args.id_field
# name_field = args.name_field


# def main(dem, basin_shp, attr_field, name_field):
#     out_dir = os.path.dirname(basin_shp) + "/calhypso_output_files/"
#     if not os.path.exists(out_dir):
#         os.mkdir(out_dir)
#     curves = get_hypsometric_curves(dem, basin_shp, attr_field, name_field)
#     fig = plt.figure()
